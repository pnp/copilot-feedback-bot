...
namespace Common.DataUtils.Http
{
    public static class HttpClientExtensions
    {
        ...
        public static async Task<HttpResponseMessage> PostAsyncWithThrottleRetries(this ConfidentialClientApplicationThrottledHttpClient httpClient, string url, string bodyContent, string mimeType, string boundary, ILogger debugTracer)
        {
            if (httpClient is null)
            {
                throw new ArgumentNullException(nameof(httpClient));
